  ...
  return (
    <>
      <header className="main-header">
        <div className="topbar-one">
          <div className="container">
            <p className="topbar-one__left">
              ...
              <strong>Horarios :</strong> Lunes-Viernes, 8am - 6pm
            </p>
        ...
        {/* Sticky Header Clonado */}
        <nav
          className="main-menu sticky-header sticky-header--cloned sticky-fixed"
          style={{ display: scrollPosition > 100 ? 'block' : 'none' }} // Mostrar solo si el scroll supera 100px
        >
          <div className="container">
            <ul className="main-menu__list">
              <li className="menu-item-has-children">
